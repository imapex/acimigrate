...
def migrate(nx, apic, nx2, auto=True, layer3=False, n1_int_list=None, n2_int_list=None):
    full_migration_dict = nx.migration_dict()
    #TODO - Test not using nx1pc_list, but use nx.pc_list() directly in below while statement
